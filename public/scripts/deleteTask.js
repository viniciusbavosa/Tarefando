  ...
  if(checkBttns) {
    checkBttns.forEach((checkBttn) => {
      ...
      checkBttn.addEventListener('click', () => {
        ...
        const svgCheckMark = '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="right:11.5%;" class="feather feather-check absolute"><polyline points="20 6 9 17 4 12"/></svg>'
